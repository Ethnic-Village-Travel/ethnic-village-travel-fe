...
import { DROPZONE_NAME, useFileUploadContext, useStoreContext, useStore } from './contexts';
import { useAsRef } from './store';

export interface FileUploadDropzoneProps extends React.ComponentPropsWithoutRef<'div'> {
  asChild?: boolean;
}

export const FileUploadDropzone = React.forwardRef<HTMLDivElement, FileUploadDropzoneProps>((props, forwardedRef) => {
